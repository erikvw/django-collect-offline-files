...
class AppConfig(DjangoAppConfig):
    ...
    pending_folder = os.path.join(settings.MEDIA_ROOT, "transactions", "pending")
    usb_incoming_folder = os.path.join(settings.MEDIA_ROOT, "transactions", "usb")
    outgoing_folder = os.path.join(settings.MEDIA_ROOT, "transactions", "outgoing")
    incoming_folder = os.path.join(settings.MEDIA_ROOT, "transactions", "incoming")
    archive_folder = os.path.join(settings.MEDIA_ROOT, "transactions", "archive")
    log_folder = os.path.join(settings.MEDIA_ROOT, "transactions", "log")
