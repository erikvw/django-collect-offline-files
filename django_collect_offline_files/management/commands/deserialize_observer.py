...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            default=None,
            help=(
                f"Specify the device role to deserialize transactions "
        ...
        parser.add_argument(
            ...
            help=(
                f"Target path on remote host. (Default: {app_config.pending_folder}. See app_config.)"
            ),
        )
    ...
    def handle(self, *args, **options):
        file_observer = self.file_observer_cls(task_processor=process_queue, **options)
        file_observer.start()
