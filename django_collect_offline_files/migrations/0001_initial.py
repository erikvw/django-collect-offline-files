    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hostname",
                    models.CharField(default=_socket.gethostname, max_length=100),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["created"], name="django_offl_created_2b049a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="exportedtransactionfilehistory",
            index=models.Index(
                fields=["sent_datetime"], name="django_offl_sent_da_e863ed_idx"
            ),
        ),
