"""
Django settings for django_offline_files project.
...
ROOT_URLCONF = 'django_offline_files.urls'
...
WSGI_APPLICATION = 'django_offline_files.wsgi.application'
...
APP_LABEL = 'django_offline_files'
COMMUNITY = ''
