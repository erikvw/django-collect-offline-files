...
#                 sent = False
#                 try:
#                     host_sftp.put(source_filename, destination_tmp_file,
#                                   callback=self.progress, confirm=True)
#                     host_sftp.rename(destination_tmp_file, destination_file)
#                     sent = True
#                 except IOError as e:
#                     raise IOError(
#                         f'IOError Got {e} . Sending {destination_tmp_file}')
#                     return False
#                 if sent and self.history_model:
#                     self._update_history(filename, sent=sent)
#             finally:
#                 host_sftp.close()
#                 client.close()
#         return sent
...
#         return archived
#
#     def _update_history(self, filename, sent=None):
